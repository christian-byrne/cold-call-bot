var beatpack = [
  {
    ...
    artist: "Niq Venus",
    src:
      "https://trevor-reznik.github.io/guides/email-template/1.mp3",
    thumbnail: "https://trevor-reznik.github.io/guides/email-template/14.jpg"
  },
  {
    name: "Roddy Ricch x Lil Tjay type beat \"HERO\"",
    artist: "Niq Venus",
    src:
      "https://trevor-reznik.github.io/guides/email-template/2.mp3",
  ...
  },
  {
    ...
    artist: "Niq Venus",
    src:
      "https://trevor-reznik.github.io/guides/email-template/3.mp3",
  ...
  },
  {
    ...
    src:
      "https://trevor-reznik.github.io/guides/email-template/4.mp3",
...
$(document).ready(function () {
  ...
  function playSong() {
    artistname.html(beatpack[CurrentSong].artist);
    musicName.html(beatpack[CurrentSong].name);
    song.src = beatpack[CurrentSong].src;
    song.play();
